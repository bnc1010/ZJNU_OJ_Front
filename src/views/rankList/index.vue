        ...
        <center>
          ...
          >
            ...
            <el-table-column label="通过数" width="160" align="center">
              <template slot-scope="scope">
                <router-link :to="'/status?username=' + scope.row.username + '&AC=true'">{{ scope.row.accepted }}</router-link>
              </template>
            </el-table-column>
            <el-table-column prop="score" label="积分" width="300" align="center"></el-table-column>
          </el-table>
        </center>
        <center>
          <div class="block">
